...
- 核心聊天与工具链路：[`gemini_api.py`](../src/mika_chat_core/gemini_api.py)
- 工具调用处理：[`gemini_api_tools.py`](../src/mika_chat_core/gemini_api_tools.py)
...
1) **轻量指标统计**
   ...
   - 在关键路径递增计数并提供快照。
   - 影响文件：[`gemini_api.py`](../src/mika_chat_core/gemini_api.py)、[`gemini_api_tools.py`](../src/mika_chat_core/gemini_api_tools.py)、[`search_engine.py`](../src/mika_chat_core/utils/search_engine.py)、[`image_cache_core.py`](../src/mika_chat_core/utils/image_cache_core.py)、[`matchers.py`](../src/mika_chat_core/matchers.py)、新增 [`metrics.py`](../src/mika_chat_core/metrics.py)。
...
1) **工具调用白名单**
   ...
   - 影响文件：[`gemini_api_tools.py`](../src/mika_chat_core/gemini_api_tools.py)、[`config.py`](../src/mika_chat_core/config.py)。
