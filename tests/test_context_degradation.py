...
class TestContextDegradation:
    ...
    async def test_context_level_0_full_context(self, mock_gemini_client):
        """Level 0 应使用完整上下文"""
    ...
    async def test_context_level_1_truncated(self, mock_gemini_client):
        """Level 1 应截断到 20 条"""
        client = mock_gemini_client
    ...
    async def test_context_level_2_minimal(self, mock_gemini_client):
        """Level 2 应使用最小上下文 (5条)"""
        client = mock_gemini_client
